...
{
	[[maybe_unused]]
	static GameDataRegistry<MonsterSkillTable> registry;

	MonsterSkill::MonsterSkill(StreamReader& reader)
	{
	...
	{
		gamebase::SoxFile fileData(path / "MONSTER_SKILL.sox");
		...
		for (const MonsterSkill& data : _vector)
		{
