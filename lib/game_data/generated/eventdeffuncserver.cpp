...
{
	[[maybe_unused]]
	static GameDataRegistry<EventdeffuncserverTable> registry;

	Eventdeffuncserver::Eventdeffuncserver(StreamReader& reader)
	{
	...
	{
		gamebase::SoxFile fileData(path / "EVENTDEFFUNCSERVER.sox");
		...
		for (const Eventdeffuncserver& data : _vector)
		{
