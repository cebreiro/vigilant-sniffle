...
{
	[[maybe_unused]]
	static GameDataRegistry<WhetherForecast2Table> registry;

	WhetherForecast2::WhetherForecast2(StreamReader& reader)
	{
	...
	{
		gamebase::SoxFile fileData(path / "WHETHER_FORECAST2.sox");
		...
		for (const WhetherForecast2& data : _vector)
		{
