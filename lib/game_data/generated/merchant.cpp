...
{
	[[maybe_unused]]
	static GameDataRegistry<MerchantTable> registry;

	Merchant::Merchant(StreamReader& reader)
	{
	...
	{
		gamebase::SoxFile fileData(path / "MERCHANT.sox");
		...
		for (const Merchant& data : _vector)
		{
