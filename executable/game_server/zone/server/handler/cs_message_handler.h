...
namespace cebreiro::zone
{
	...
	public:
		...
		virtual void Handle(const IServiceLocator& locator, ZoneSessionContext& context, gamebase::PacketReader& reader) = 0;
	};
	...
	public:
		...
		virtual auto Handle(const IServiceLocator& locator, std::shared_ptr<ZoneSessionContext> context, gamebase::PacketReader& reader)
			-> Future<void> = 0;
	};
	...
	public:
		...
		void Handle(const IServiceLocator& locator, ZoneSessionContext& context, gamebase::PacketReader& reader) final
		{
			T message = {};
		...
		virtual void OnMessage(const IServiceLocator& locator, ZoneSessionContext& context, const T& message) = 0;
	};
	...
	public:
		...
		auto Handle(const IServiceLocator& locator, std::shared_ptr<ZoneSessionContext> context, gamebase::PacketReader& reader)
			-> Future<void> final
		{
			T message = {};
			message.Deserialize(reader);
		...
		virtual auto OnMessage(const IServiceLocator& locator, ZoneSessionContext& context, const T& message)
			-> Future<void> = 0;
	};
}